<head>
<link rel='stylesheet' id='terms_of_service.css' href='css/terms_of_service.css' type='text/css' media='all'>
</head>
<?php
...
echo <<<EOL
<title>GudaNews- Terms Of Service</title>
EOL;
...
echo <<<EOL
<div class="terms_of_service_title">
<strong>Gudanews Terms Of Use</strong>
</div>

<div class="terms_of_service_content">
Last Revised: October 13, 2020 <br><br>

This website and any mobile application (collectively, this “Site”) is owned by GudaNews (“We”, “Us” or “GudaNews”). We are providing you with access to this Site and our online store (together, our “Services”) subject to the following terms and conditions.
...
This Site may include features and functionality (“Interactive Features”) that allows users to create, post, transmit or store any content, such as text, music, sound, photos, video, graphics or code on the Sites ("User Content"). User Content is publicly-viewable and may include your profile information and any content you post pursuant to your profile, but it does not include your account information or information you submit in order to make a purchase. You agree that you are solely<br> responsible for your User Content and for your use of Interactive Features, and that your use any Interactive Features at your own risk.<br>
By using any Interactive Areas, you agree not to post, upload to, transmit, distribute, store, create or otherwise publish or send through the Sites any of the following:<br>
User Content that is unlawful, libelous, defamatory, obscene, pornographic, indecent, lewd, suggestive, harassing, threatening, abusive, inflammatory, fraudulent or otherwise objectionable;<br>
User Content that would constitute, encourage or provide instructions for a criminal offense, violate the rights of any party or that would otherwise create liability or violate any local, state, national or international law;<br>
User Content that displays, describes or encourages usage of any product We sell in a manner that could be offensive, inappropriate or harmful to Us or any user or consumer;<br>
User Content that may impinge upon or violate the publicity, privacy or data protection rights of others, including pictures, videos, images or information about another individual where you have not obtained such individual's consent;<br>
User Content that makes false or misleading statements, claims or depictions about a person, company, product or service;<br>
User Content that may infringe any patent, trademark, trade secret, copyright or other intellectual or proprietary right of any party;<br>
...
<div class="terms_of_service_sub_title">
<strong>Restrictions on Rights to Use</strong><br><br>
</div>

<div class="terms_of_service_content">

You agree you shall not (and you agree not to allow any other individual or entity using your password and identification to):<br>
download‚ modify‚ reproduce‚ adapt‚ translate‚ reverse engineer‚ create derivative works based upon‚ publicly display‚ sell‚ rent‚ license‚ or in any way commercially exploit any portion of this Site‚ except and to the extent expressly permitted under these Terms;<br>
remove any copyright‚ trademark or other proprietary rights notice contained in or on the Site;<br>
use any robot‚ spider‚ site search/retrieval application‚ or other device to retrieve or index any portion of this Site;<br>
collect any information about other users (including usernames and/or email addresses) for any purpose other than to solicit and/or share reviews with other users;<br>
reformat or frame any portion of any Web pages that are part of this Site;<br>
create user accounts by automated means or under false or fraudulent pretenses;<br>
create or transmit to other users unsolicited electronic communications‚ such as “spam‚” or otherwise interfere with other users’ enjoyment of the Site;<br>
submit to this Site any content that falsely states or implies that such content is sponsored or endorsed by us;<br>
transmit or upload to this Site any item containing or embodying any virus‚ worm‚ defect‚ malware‚ Trojan horse‚ software bomb or other feature designed to damage or degrade in any manner the performance of this Site‚ any other Web site‚ or any computer or other device or system‚ or the enjoyment of this Site by any user;<br>
use this Site to violate the security of or gain unauthorized access to any computer or computer network or other device or system (including unauthorized attempts to discover passwords or security encryption codes);<br>
submit to this Site any content that is unlawful or facilitates‚ constitutes‚ promotes or encourages illegal activity; or otherwise use the Site to transfer or store illegal material‚ including any material deemed threatening or obscene;<br>
copy or store any User Content offered on this Site other than for your personal‚ non-commercial use;<br>
...
use this Site and/ or any User Content‚ intentionally or unintentionally‚ to violate any applicable local‚ state‚ federal or international law.<br>
We have no obligation to monitor any user conduct on this Site, and We reserve the right and have absolute discretion to monitor any user conduct on this Site at any time and for any reason without notice.<br><br>
...
The risk of loss and title for items purchased by you on this Site pass to you upon our delivery of the items to the carrier pursuant to a shipment contract.<br>
We charge sales tax for merchandise ordered on this Site based on the applicable state sales tax rate of the location to which the order is being shipped.<br>
...
This Site may contain links to other sites on the Internet that are owned and operated by third parties. You acknowledge that We are not responsible for the operation of or content located on or through any such site.<br><br>
...
To the fullest extent permitted by applicable law, you agree to defend, indemnify and hold harmless Us and our subsidiaries and affiliates, and our respective officers, directors, agents, partners, members, employees, independent contractors, service providers and consultants ("Our Related Parties"), from and against any claims, damages, costs, liabilities and expenses (collectively, "Claims") arising out of or related to (a) your access to and use or misuse of this Site; (b) any User Content you post, upload, use, distribute, store or otherwise transmit on or through this Site; (c) any Feedback that you provide; (d) your violation of these Terms; and (e) your violation of any rights of another. You agree to promptly notify Us of any third party Claims, cooperate with Us in defending such Claims and pay all fees, costs and expenses associated with defending such Claims (including but not limited to attorneys' fees). You further agree that the We shall have the right to control of the defense or settlement of any third party Claims.<br><br>
...
No right or remedy of ours shall be exclusive of any other, whether at law or in equity, including without limitation damages injunctive relief, attorneys' fees and expenses.<br><br>

</div>

<div class="terms_of_service_sub_title">
<strong>Modifications to Site</strong><br><br>
</div>
...
If any these provisions shall be deemed invalid, void, or for any reason unenforceable, that condition shall be deemed several and shall not affect the validity and enforceability of any remaining provision.<br><br>

</div>

<div class="terms_of_service_sub_title">
<strong>No Third-Party Beneficiaries</strong><br><br>
</div>
...
Questions regarding these Terms, Our Privacy Policy, or other policy related material can be directed to our support staff by emailing us at: gudanews.com@gmail.com.<br><br>
</div>
EOL;
